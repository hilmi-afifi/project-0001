...
?>
<link rel="stylesheet" href="../../setting/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css">
...
<script>$(function(){$("#Jam_Mulai2").datetimepicker({format:"HH:mm"});$("#Jam_Selesai2").datetimepicker({format:"HH:mm"})});</script>
